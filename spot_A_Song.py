...
def main():
    ...
    #Displayes the second bar graph of the top 5 danceability scores and songs ->
    # gives users ability to compare their song to the top 5 songs to see if it has a high danceability score       
